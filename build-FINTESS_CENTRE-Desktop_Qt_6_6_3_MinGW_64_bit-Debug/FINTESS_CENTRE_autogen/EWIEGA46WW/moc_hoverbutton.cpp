...
#include "../../../FINTESS_CENTRE/hoverbutton.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSHoverButtonENDCLASS_t qt_meta_stringdata_CLASSHoverButtonENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 12),  // "mouseEntered"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 9)   // "mouseLeft"
    },
    "HoverButton",
    "mouseEntered",
    "",
...
void HoverButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HoverButton::mouseEntered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HoverButton::*)();
            if (_t _q_method = &HoverButton::mouseLeft; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HoverButton::mouseEntered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HoverButton::mouseLeft()
{
